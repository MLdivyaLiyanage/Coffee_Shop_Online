...
class DescYellowCake : AppCompatActivity() {
    ...
    private lateinit var lButterCake: Button
    private lateinit var mButterCake: Button
    private lateinit var sButterCake: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize views
        lButterCake = findViewById(R.id.lButterCake)
        mButterCake = findViewById(R.id.mButterCake)
        sButterCake = findViewById(R.id.sButterCake)
    ...
    private fun resetButtonColors() {
        lButterCake.setBackgroundColor(Color.parseColor("#8B4513"))
        mButterCake.setBackgroundColor(Color.parseColor("#8B4513"))
        sButterCake.setBackgroundColor(Color.parseColor("#8B4513"))
    }
