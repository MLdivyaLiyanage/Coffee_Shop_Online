...
class tableBooking2 : AppCompatActivity() {
    ...
    private val bookingHistory2 = StringBuilder()
    private var selectedBranch: String? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.table_booking2)

        databaseRef = FirebaseDatabase.getInstance().getReference("BookingHistoryBusStand")
    ...
    private fun fetchTableStatus() {
        ...
        databaseRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@tableBooking2, "Error fetching data: ${error.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
    ...
    private fun handleTableBooking(button: Button, tableName: String) {
        ...
        bookingHistory2.append(message).append("\n")
        display.text = bookingHistory2.toString()
