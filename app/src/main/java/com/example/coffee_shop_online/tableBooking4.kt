...
class tableBooking4 : AppCompatActivity() {
    ...
    private val bookingHistory4 = StringBuilder()
    private var selectedBranch: String? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.table_booking4)

        databaseRef = FirebaseDatabase.getInstance().getReference("BookingHistoryMagalle")
    ...
    private fun fetchTableStatus() {
        ...
        databaseRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@tableBooking4, "Error fetching data: ${error.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
    ...
    private fun handleTableBooking(button: Button, tableName: String) {
        ...
        bookingHistory4.append(message).append("\n")
        display.text = bookingHistory4.toString()
