    ...
    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
        ...
        holder.nextArrow.setOnClickListener {
            ...
            val intent = when (position) {
                0 -> Intent(context, DescOreoMilk::class.java)
                1 -> Intent(context, DescBananaShake::class.java)
                2 -> Intent(context, DescStrawberryShake::class.java)
                3 -> Intent(context, DescMochaShakes::class.java)
                4 -> Intent(context, DescLatteShake::class.java)
                5 -> Intent(context, DescAvocadoShake::class.java)
                else -> null
            }
