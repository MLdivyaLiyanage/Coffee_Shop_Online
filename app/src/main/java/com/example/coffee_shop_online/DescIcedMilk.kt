...
class DescIcedMilk : AppCompatActivity() {

    private lateinit var lMilk: Button
    private lateinit var mMilk: Button
    private lateinit var sMilk: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_desc_iced_milk)

        // Initialize Firebase Database reference
        database = FirebaseDatabase.getInstance().reference

        // Initialize views
        lMilk = findViewById(R.id.lPremiumCapp)
        mMilk = findViewById(R.id.mPremiumCapp)
        sMilk = findViewById(R.id.sPremiumCapp)
        ...
        lMilk.setOnClickListener { selectSize("Large Iced Milk", lMilk) }
        mMilk.setOnClickListener { selectSize("Medium Iced Milk", mMilk) }
        sMilk.setOnClickListener { selectSize("Small Iced Milk", sMilk) }
    ...
    private fun resetButtonColors() {
        lMilk.setBackgroundColor(Color.parseColor("#8B4513"))
        mMilk.setBackgroundColor(Color.parseColor("#8B4513"))
        sMilk.setBackgroundColor(Color.parseColor("#8B4513"))
    }
