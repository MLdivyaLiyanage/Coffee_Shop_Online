...
class tableBooking7 : AppCompatActivity() {
    ...
    private val bookingHistory7 = StringBuilder()
    private var selectedBranch: String? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.table_booking7)

        databaseRef = FirebaseDatabase.getInstance().getReference("BookingHistoryBeachRoad")
    ...
    private fun fetchTableStatus() {
        ...
        databaseRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@tableBooking7, "Error fetching data: ${error.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
    ...
    private fun handleTableBooking(button: Button, tableName: String) {
        ...
        bookingHistory7.append(message).append("\n")
        display.text = bookingHistory7.toString()
