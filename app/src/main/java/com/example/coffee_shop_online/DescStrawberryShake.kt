...
class DescStrawberryShake : AppCompatActivity() {

    private lateinit var lSshake: Button
    private lateinit var mSshake: Button
    private lateinit var sSshake: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_desc_strawberry_shake)

        // Initialize Firebase Database reference
        database = FirebaseDatabase.getInstance().reference

        // Initialize views
        lSshake = findViewById(R.id.lSshake)
        mSshake = findViewById(R.id.mSshake)
        sSshake = findViewById(R.id.sSshake)
    ...
    private fun resetButtonColors() {
        lSshake.setBackgroundColor(Color.parseColor("#8B4513"))
        mSshake.setBackgroundColor(Color.parseColor("#8B4513"))
        sSshake.setBackgroundColor(Color.parseColor("#8B4513"))
    }
