...
class DescBurger : AppCompatActivity() {

    private lateinit var lBurger: Button
    private lateinit var mBurger: Button
    private lateinit var sBurger: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_desc_burger)

        // Initialize Firebase Database reference
        database = FirebaseDatabase.getInstance().reference

        // Initialize views
        lBurger = findViewById(R.id.lBurger)
        mBurger = findViewById(R.id.mBurger)
        sBurger = findViewById(R.id.sBurger)
    ...
    private fun resetButtonColors() {
        lBurger.setBackgroundColor(Color.parseColor("#8B4513"))
        mBurger.setBackgroundColor(Color.parseColor("#8B4513"))
        sBurger.setBackgroundColor(Color.parseColor("#8B4513"))
    }
