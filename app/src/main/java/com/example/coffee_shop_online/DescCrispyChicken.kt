...
class DescCrispyChicken : AppCompatActivity() {
    ...
    private lateinit var lChicken: Button
    private lateinit var mChicken: Button
    private lateinit var sChicken: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize views
        lChicken = findViewById(R.id.lPremiumCapp)
        mChicken = findViewById(R.id.mPremiumCapp)
        sChicken = findViewById(R.id.sPremiumCapp)
    ...
    private fun resetButtonColors() {
        lChicken.setBackgroundColor(Color.parseColor("#8B4513"))
        mChicken.setBackgroundColor(Color.parseColor("#8B4513"))
        sChicken.setBackgroundColor(Color.parseColor("#8B4513"))
    }
