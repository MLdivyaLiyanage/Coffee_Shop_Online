...
class DescIcedMocha : AppCompatActivity() {
    ...
    private lateinit var lIcedMocha: Button
    private lateinit var mIcedMocha: Button
    private lateinit var sIcedMocha: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize views
        lIcedMocha = findViewById(R.id.lPremiumCapp)
        mIcedMocha = findViewById(R.id.mPremiumCapp)
        sIcedMocha = findViewById(R.id.sPremiumCapp)
    ...
    private fun resetButtonColors() {
        lIcedMocha.setBackgroundColor(Color.parseColor("#8B4513"))
        mIcedMocha.setBackgroundColor(Color.parseColor("#8B4513"))
        sIcedMocha.setBackgroundColor(Color.parseColor("#8B4513"))
    }
