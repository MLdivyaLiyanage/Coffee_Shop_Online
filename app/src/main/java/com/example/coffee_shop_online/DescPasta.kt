...
class DescPasta : AppCompatActivity() {

    private lateinit var lPasta: Button
    private lateinit var mPasta: Button
    private lateinit var sPasta: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_desc_pasta)

        // Initialize Firebase Database reference
        database = FirebaseDatabase.getInstance().reference

        // Initialize views
        lPasta = findViewById(R.id.lPasta)
        mPasta = findViewById(R.id.mPasta)
        sPasta = findViewById(R.id.sPasta)
    ...
    private fun resetButtonColors() {
        lPasta.setBackgroundColor(Color.parseColor("#8B4513"))
        mPasta.setBackgroundColor(Color.parseColor("#8B4513"))
        sPasta.setBackgroundColor(Color.parseColor("#8B4513"))
    }
