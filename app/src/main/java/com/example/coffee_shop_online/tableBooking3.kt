...
class tableBooking3 : AppCompatActivity() {
    ...
    private val bookingHistory3 = StringBuilder()
    private var selectedBranch: String? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.table_booking3)

        databaseRef = FirebaseDatabase.getInstance().getReference("BookingHistoryWakwella")
    ...
    private fun fetchTableStatus() {
        ...
        databaseRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@tableBooking3, "Error fetching data: ${error.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
    ...
    private fun handleTableBooking(button: Button, tableName: String) {
        ...
        bookingHistory3.append(message).append("\n")
        display.text = bookingHistory3.toString()
