...
class tableBooking6 : AppCompatActivity() {
    ...
    private val bookingHistory6 = StringBuilder()
    private var selectedBranch: String? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.table_booking6)

        databaseRef = FirebaseDatabase.getInstance().getReference("BookingHistoryNupe")
    ...
    private fun fetchTableStatus() {
        ...
        databaseRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@tableBooking6, "Error fetching data: ${error.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
    ...
    private fun handleTableBooking(button: Button, tableName: String) {
        ...
        bookingHistory6.append(message).append("\n")
        display.text = bookingHistory6.toString()
