...
class DescSkinnyIceCocktail : AppCompatActivity() {

    private lateinit var lCocktail: Button
    private lateinit var mCocktail: Button
    private lateinit var sCocktail: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_desc_skinny_ice_cocktail)

        // Initialize Firebase Database reference
        database = FirebaseDatabase.getInstance().reference

        // Initialize views
        lCocktail = findViewById(R.id.lCocktail)
        mCocktail = findViewById(R.id.mCocktail)
        sCocktail = findViewById(R.id.sCocktail)
    ...
    private fun resetButtonColors() {
        lCocktail.setBackgroundColor(Color.parseColor("#8B4513"))
        mCocktail.setBackgroundColor(Color.parseColor("#8B4513"))
        sCocktail.setBackgroundColor(Color.parseColor("#8B4513"))
    }
