...
class DescMichelada : AppCompatActivity() {

    private lateinit var lMichelada: Button
    private lateinit var mMichelada: Button
    private lateinit var sMichelada: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_desc_michelada)

        // Initialize Firebase Database reference
        database = FirebaseDatabase.getInstance().reference

        // Initialize views
        lMichelada = findViewById(R.id.lMichelada)
        mMichelada = findViewById(R.id.mMichelada)
        sMichelada = findViewById(R.id.sMichelada)
    ...
    private fun resetButtonColors() {
        lMichelada.setBackgroundColor(Color.parseColor("#8B4513"))
        mMichelada.setBackgroundColor(Color.parseColor("#8B4513"))
        sMichelada.setBackgroundColor(Color.parseColor("#8B4513"))
    }
