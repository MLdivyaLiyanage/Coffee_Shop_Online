...
class DescLatteShake : AppCompatActivity() {

    private lateinit var lLatteShake: Button
    private lateinit var mLatteShake: Button
    private lateinit var sLatteShake: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_desc_latte_shake)

        // Initialize Firebase Database reference
        database = FirebaseDatabase.getInstance().reference

        // Initialize views
        lLatteShake = findViewById(R.id.lLatteShake)
        mLatteShake = findViewById(R.id.mLatteShake)
        sLatteShake = findViewById(R.id.sLatteShake)
    ...
    private fun resetButtonColors() {
        lLatteShake.setBackgroundColor(Color.parseColor("#8B4513"))
        mLatteShake.setBackgroundColor(Color.parseColor("#8B4513"))
        sLatteShake.setBackgroundColor(Color.parseColor("#8B4513"))
    }
